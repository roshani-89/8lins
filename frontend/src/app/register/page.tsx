...
export default function EntryRegChoicePage() {
  return (
    <main className="min-h-screen bg-void flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-4xl relative z-10 px-6 py-20 flex flex-col items-center">
        <div className="text-center mb-16 px-4">
          ...
          <div className="text-[10px] md:text-[12px] tracking-[10px] text-navy/40 uppercase font-bold uppercase tracking-[8px]">REGISTRY SELECTION // NEW ENTITY</div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full">
          {/* Drive Portal */}
          <Link href="/drive/register" className="group bg-white border border-navy/5 p-12 hover:border-orange/30 transition-all duration-500 shadow-xl hover:shadow-2xl cut-lg relative overflow-hidden text-center md:text-left">
            <div className="absolute inset-0 bg-gradient-to-tr from-orange/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 " />
            <div className="relative z-10">
              <div className="text-[10px] tracking-[6px] text-orange uppercase mb-6 font-black flex items-center justify-center md:justify-start gap-3">
                <span className="w-8 h-px bg-orange"/> RENTER REGISTRY
              </div>
              ...
              <p className="text-[14px] text-ash/70 font-medium mb-10 max-w-[280px] group-hover:text-ash transition-colors uppercase tracking-widest leading-loose">
                Enroll in the elite fleet nodes. Hub-maintained. Premium only.
              </p>
          ...
          {/* Investor Portal */}
          <Link href="/investor/register" className="group bg-white border border-navy/5 p-12 hover:border-green/20 transition-all duration-500 shadow-xl hover:shadow-2xl cut-lg relative overflow-hidden text-center md:text-right">
             <div className="absolute inset-0 bg-gradient-to-tl from-green/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 " />
            <div className="relative z-10">
              <div className="text-[10px] tracking-[6px] text-green uppercase mb-6 font-black flex items-center justify-center md:justify-end gap-3">
                ASSET REGISTRY <span className="w-8 h-px bg-green"/>
              </div>
              ...
              <p className="text-[14px] text-ash/70 font-medium mb-10 max-w-[280px] ml-auto group-hover:text-ash transition-colors uppercase tracking-widest leading-loose">
                Submit your asset. Secure 70% net yield. Bengaluru South Hub Alpha.
              </p>
